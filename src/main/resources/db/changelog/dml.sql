...
INSERT INTO users (lastname, firstname, surname, birthdate)
VALUES ('Иванов', 'Иван', 'Иванович', '1990-01-01'),
       ('Петров', 'Петр', 'Петрович', '1991-02-02'),
       ('Сидоров', 'Сидор', 'Сидорович', '1992-03-03'),
       ('Смирнов', 'Алексей', 'Алексеевич', '1993-04-04'),
       ('Кузнецов', 'Дмитрий', 'Дмитриевич', '1994-05-05'),
       ('Попов', 'Сергей', 'Сергеевич', '1995-06-06'),
       ('Васильев', 'Василий', 'Васильевич', '1996-07-07'),
       ('Новиков', 'Николай', 'Николаевич', '1997-08-08'),
       ('Морозов', 'Андрей', 'Андреевич', '1998-09-09'),
       ('Соловьев', 'Кирилл', 'Кириллович', '1999-10-10'),
       ('Орлов', 'Олег', 'Олегович', '2000-11-11'),
       ('Лебедев', 'Леонид', 'Леонидович', '2001-12-12'),
       ('Соколова', 'Анна', 'Андреевна', '1990-01-13'),
       ('Зайцева', 'Елена', 'Евгеньевна', '1991-02-14'),
       ('Котова', 'Ирина', 'Ивановна', '1992-03-15'),
       ('Федорова', 'Мария', 'Михайловна', '1993-04-16'),
       ('Белова', 'Ольга', 'Олеговна', '1994-05-17'),
       ('Егорова', 'Татьяна', 'Тимофеевна', '1995-06-18'),
       ('Волкова', 'Наталья', 'Николаевна', '1996-07-19'),
       ('Павлова', 'Екатерина', 'Евгеньевна', '1997-08-20'),
       ('Семенова', 'Марина', 'Марковна', '1998-09-21'),
       ('Горбунова', 'Вера', 'Владимировна', '1999-10-22'),
       ('Степанова', 'Людмила', 'Львовна', '2000-11-23'),
       ('Антонова', 'Алиса', 'Александровна', '2001-12-24');
